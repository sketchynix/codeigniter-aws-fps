...
class Amazon_FPS_CBUIPipeline extends CI_Driver {
    ...
    public function signParameters(array $parameters, $httpMethod, $host, $requestURI) {
        ...
        return self::_sign($stringToSign, $this->_ci->config->item('aws_secret_access_key'), $algorithm);
    }
...
/* End of file Aws_fps_cbui_base.php */
/* Location: ./application/libraries/Aws_fps/base/Aws_fps_cbui_base.php */