...
/**
 * Amazon_FPS_Model_ReserveRequest
 * 
 * Properties:
 * <ul>
 * 
 ...
 * <li>MarketplaceFixedFee: Amazon_FPS_Model_Amount</li>
 * <li>MarketplaceVariableFee: int</li>
 *
 * </ul>
 */ 
class Amazon_FPS_Model_ReserveRequest extends Amazon_FPS_Model
{


    /**
     * Construct new Amazon_FPS_Model_ReserveRequest
     * 
    ...
    public function __construct($data = null)
    {
        ...
        'ChargeFeeTo' => array('FieldValue' => null, 'FieldType' => 'string'),
        ...
        'MarketplaceFixedFee' => array('FieldValue' => null, 'FieldType' => 'Amazon_FPS_Model_Amount'),
     ...
     * @return Amazon_FPS_Model_ReserveRequest instance
     */
     ...
     * 
     * @param string $value ChargeFeeTo
     * @return Amazon_FPS_Model_ReserveRequest instance
     */
    public function withChargeFeeTo($value)
    {
        $this->setChargeFeeTo($value);
        return $this;
    }
    ...
    {
        return !is_null($this->_fields['ChargeFeeTo']['FieldValue']);
    }
     ...
     * @return Amazon_FPS_Model_ReserveRequest instance
     */
    public function withMarketplaceFixedFee($value)
    {
        $this->setMarketplaceFixedFee($value);
        return $this;
    }
    ...
    {
        return !is_null($this->_fields['MarketplaceFixedFee']['FieldValue']);
     ...
     * @return Amazon_FPS_Model_ReserveRequest instance
     */
    public function withMarketplaceVariableFee($value)
    {
        $this->setMarketplaceVariableFee($value);
        return $this;
    }
    ...
    {
        return !is_null($this->_fields['MarketplaceVariableFee']['FieldValue']);
    }
